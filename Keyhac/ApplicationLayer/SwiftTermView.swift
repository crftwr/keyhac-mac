...
struct SwiftTermView: NSViewControllerRepresentable {
    ...
    var viewController: SwiftTermViewController
    
    init(viewController: SwiftTermViewController) {
...
class SwiftTermViewController: NSViewController, LocalProcessTerminalViewDelegate, NSUserInterfaceValidations {
